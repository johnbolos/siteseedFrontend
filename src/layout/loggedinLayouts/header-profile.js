                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu className="animate slideIn">
                                    <Dropdown.Item as="div">
                                        <a onClick={() => { document.getElementById('nav-profile-tab').click() }} href="#nav-profile" data-bs-toggle="tab" role="tab">Profile</a>
                                    </Dropdown.Item>
                                    <Dropdown.Item as="div">
                                        <a onClick={() => { document.getElementById('nav-account-tab').click() }} href="#account" data-bs-toggle="tab" role="tab">Account & Security</a>
                                    </Dropdown.Item>
                                    <Dropdown.Item as="div">
                                        <a onClick={() => { document.getElementById('nav-contact-tab').click() }} href="#notification" data-bs-toggle="tab" role="tab">Notifications</a>
                                    </Dropdown.Item>
                                    {/* <Dropdown.Item as="div">
                            ...
                            <ul>
                                ...
                                <div className="d-flex total-export-credits">
                                    <div className="d-flex">
                                        ...
                                        <div>
                                            <p><b>{ userGeneralData?.total_sites - userGeneralData?.total_user_sites < 0 ? 0 : userGeneralData?.total_sites - userGeneralData?.total_user_sites }/{ userGeneralData?.total_sites } left</b> Total Website</p>
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div>
                                            <p><b>{ userGeneralData?.export_credits - userGeneralData?.total_user_exports < 0 ? 0 : userGeneralData?.export_credits - userGeneralData?.total_user_exports }/{ userGeneralData?.export_credits } left</b> Export Credits</p>
