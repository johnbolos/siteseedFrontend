                    ...
                    <div className="bottom-navigation_wrapper col-12">
                        ...
                        <nav className={`header_nav_wrapper ${hamburger ? 'open-menu' : 'closed-menu'}`}>
                            <ul>
                                ...
                                <li>
                                    <NavLink activeClassName="active" to="/domains">Domains</NavLink>
                                </li>
                                <li>
                                    <NavLink activeClassName="active" to="/billing">Billing Information</NavLink>
                                </li>
                                <li>
                                    <NavLink activeClassName="active" to="/subscription">Subscriptions</NavLink>
                                </li>
                                <div className="d-flex total-export-credits">
                                    <div className="d-flex">
                                        <div className="total-icon">
                                            <svg width="10" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
