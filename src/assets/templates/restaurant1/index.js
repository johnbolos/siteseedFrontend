...
@media only screen and (max-width: 812px) and (min-width: 800px){
	...
	.content2 ul.navbar-nav.ml-auto {
	   ...
	   .B-heading {
		...
		.col-md-3.b-w {
		width: 50%;
		border-right: 1px solid #BCB495;
		border-bottom: 1px solid #BCB495;
	}
		.col-md-3.b-w-2 {
		width: 50%;
		border-bottom: 1px solid #BCB495;
	   ...
	   .col-md-3.b-w-1 {
		...
		select#cars-1, select#cars-2, select#cars-3 {
		width: 100%;
		}
	...
	#basic-select-1 select, #basic-select-2 select, #basic-select-3 select {
	appearance: none;
	-webkit-appearance: none;
	-moz-appearance: none;
	}
	
	#basic-select-1::after, #basic-select-2::after, #basic-select-3::after {
...
.navbar-dark .navbar-nav .nav-link {
    font-size: 18px;
    font-family: 'roslindale_testingtextSBd';
...
.menuoftheday{margin-top: 128px;margin-bottom: 50px;}
...
.image_off, #hom-1:hover .image_on, #hom-2:hover .image_on, #hom-3:hover .image_on {
	display: none;
}

.image_on, #hom-1:hover .image_off, #hom-2:hover .image_off, #hom-3:hover .image_off {
	display: inline-block;
}


select#cars-1::before, select#cars-2::before, select#cars-3::before {
  ...
  <div class="container nav-container">
	...
	<div class="navbar-collapse hideshow content2 w100 " id="navbarResponsive">
	  <ul class="navbar-nav ml-auto ">
		...
		<li class="nav-item">
		  <a class="nav-link" href="#Gallery-secrion">Gallery</a>
		</li>
		<li class="nav-item">
		  <a class="nav-link" href="#Menu-section">Menu</a>
		</li>
		  <li class="nav-item">
		  <a class="nav-link" href="#Contact-section">Find Us</a>
		</li>
	  </ul>
	</div>
	  <div class="wrapper">
...
<p class="top-tagline">The Fututre of tradition</p>
<h1 class="top-heading">Food so good... it’s <br>addictive</h1></div></div> 
	
<div class="row"> 
<div class="col-md-6">      
<p class="top-paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut sem urna, elementum nec ultrices sed, commodo eget augue. </p> </div>
	
<div class="col-lg-6 col-md-12 mb-12 buttons-div">
<button type="button" class="btn btn-outline">Reserve a table</button>      
</div> </div>     
</div>
...
He has absorbed his Italian-Argentinian cultural heritage and that of the chefs with whom he trained, and now follows his intuition as he draws on the local culture on both sides of the border.</p><br>
...
<p class="top-paragraph">Inspired by the sea, the mountains and the fruit and vegetables grown in his own gardens, Mauro invents colourful, pictorial dishes that play with textures and bold contrasts.</p>  
  ...
  <div class="col-lg-6 col-md-6 mb-12 split-text" style="padding-right: 0px;"> 
   ...
   <div class="col-lg-12 col-md-12 mb-12 slide-right" style="padding-left: 0px">   
	   <marquee width="100%" direction="right" scrollamount="20">
		   <h1 class="menu-inner-text">Menu of </h1> </marquee>
   ...
   <p class="top-paragraph">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis Theme natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui.</p>
	...
	<section class="tabs-section main-body" id="Menu-section">
...
<div class="tab-content">
  <div id="menu1" class="tab-pane active show">
	<div class="row">
	  ...
	  <div class="col-md-2 R-list"><p class="tabs-heading">50$</p></div>    
	  </div>
	  ...
	  <div class="col-md-2 R-list"><p class="tabs-heading">20$</p></div>    
	  </div>
	  ...
	  <div class="col-md-2 R-list"><p class="tabs-heading">70$</p></div>    
	  </div>
	  ...
	  <div class="col-md-2 R-list"><p class="tabs-heading">30$</p></div>    
	  </div>
	  ...
	  <div class="col-md-2 R-list"><p class="tabs-heading">80$</p></div>    
	  </div>    
  ...
  <div id="menu2" class="tab-pane fade">
	<div class="row">
	  ...
	  <div class="col-md-2 L-list"><p class="tabs-heading">70$</p></div>    
	  </div>
		  
	  <div class="row inner-table">    
	  <div class="col-md-10 L-list">
	   <p class="tabs-heading">Guillot Broux ‘Genievrieres’ 2015 30$</p>
	   <p class="tabs-para">France (Burgundy) Chardonnay </p>    
	  </div>
	  <div class="col-md-2 R-list"><p class="tabs-heading">30$</p></div>    
	  </div>
	  ...
	  <div class="row inner-table">    
	  <div class="col-md-10 L-list">
	   <p class="tabs-heading">Day Wines ‘Cancilla Vineyard’ 2014 20$</p>
	   <p class="tabs-para"> France (Champagne) Chardonnay, Pinot Noir  </p>    
	  </div>
	  <div class="col-md-2 R-list"><p class="tabs-heading">20$</p></div>    
	  </div>
	  ...
	  <div class="row inner-table">    
	  <div class="col-md-10 L-list">
	   <p class="tabs-heading">Clos Tue Boeuf ‘Petit Blanc’ 2013 20$</p>
	   <p class="tabs-para">France (Loire) </p>    
	  </div>
	  <div class="col-md-2 R-list"><p class="tabs-heading">20$</p></div>    
	  </div>
	  ...
	  <div class="row inner-table">    
	  <div class="col-md-10 L-list">
	   <p class="tabs-heading">Niepoort ‘Redoma Branco’ 2012 80$</p>
	   <p class="tabs-para"> Portugal (Douro) Rabigato</p>    
	  </div>
	  <div class="col-md-2 R-list"><p class="tabs-heading">80$</p></div>    
	  </div>    
  ...
  <div id="menu4" class="tab-pane fade">
   ...
   <div class="row">
	...
	<div class="row avilable-section main-body">
		...
		<h1 class="B-heading head-W">We are available for dinnings & events</h1>
		</div>
 ...
 <select id="cars-2" name="cars">
  <option value="volvo">7:00AM</option> 
 </select> 
 </div>
	  
  <div id="basic-select-3" class="col-lg-3 col-md-3 mb-12 R-pading ">    
  <select id="cars-3" name="cars">
  <option class="color-set"value="volvo">2 Peoples</option>
  <option class="color-set"value="saab">3 Peoples</option>
  <option class="color-set"value="fiat">4 Peoples</option>
  <option class="color-set"value="audi">5 Peoples</option>
 </select>    
 </div>
...
<footer class="py-5 bg-dark main-body" id="Contact-section">
  <div class="container R-pading">
	  ...
	  <div class="row"><p class="copyright-text">© 2020 SiteSeed. All Rights Reserved.</p></div>
  </div>
  <!-- /.container -->
</footer>
