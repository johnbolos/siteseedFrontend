...
@media only screen and (max-width: 1921px) and (min-width: 1901px) {
  ...
  .BOX-1 {
    padding: 51px 20px 36px 20px !important;
  }
	...
	<div class="container-fluid">
			...
			<div class="offset-md-1 col-md-10 offset-lg-1 col-lg-10  offset-mb-0 mb-12 p-0 ">
				<div class="row text-center">
					<div class="col-lg-6 col-md-6 mb-12">
						<img class="img-responsive" src="${assetsUrl}/templates/spa/images/about-us-img.jpg">
					</div>
        ...
        Spa Experience  
          ...
          <div class="img-container">
							...
							<img class="img-responsive image" src="${assetsUrl}/templates/spa/images/vedio-imge.jpg">
							<div class="overlay"> <span id="hom" class="hom"><img class="popup image_on" src="${assetsUrl}/templates/spa/images/play-button-B.png"><img class="popup image_off" src="${assetsUrl}/templates/spa/images/play-button-G.png"></span>
							</div>
						</div>
						<!--modal button-->
...
<script>
	var url = $("#cartoonVideo").attr('src');
	    ...
	    $("#testimonial-slider").owlCarousel({
	        ...
	        pagination:true,
	        navigation:true,
	        navigationText : ['<img class="T-D leftsmall" onclick="hide1()" src="images/S_Arrow_Right-1.png"> <img class="T-D-1 leftbig" onclick="hide1()" src="images/Arrow_Left_Black.png" style="display: none;">','<img class="T-D rightbig" onclick="hide2()" src="images/Arrow_Right_Black.png"> <img class="T-D-1 rightsmall" onclick="hide2()" src="images/S_Arrow_Right.png" style="display: none;">'],
	        slideSpeed:1000,
	        autoPlay:true
	    });
	});
