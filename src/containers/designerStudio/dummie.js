...
export const template1Html = `
  <header id="ittj" class="header-banner">
    <div id="izam" class="container-width">
  ...
  <section id="iam5t" class="flex-sect">
    <div id="i4hkl" class="container-width">
      <div id="ii4c3" class="flex-title">Flex is the new black
        </div>
      <div id="ijjbr" class="flex-desc">With flexbox system you're able to build complex layouts easily and with free responsivity
        </div>
